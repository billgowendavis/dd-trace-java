...
class PollerRequestFactory {
  ...
  PollerRequestFactory(Config config,
  ...
  Request newConfigurationRequest(Collection<String> productNames,
    ...
    RequestBody requestBody =
        RequestBody.create(applicationJson, buildRemoteConfigRequestJson(productNames, clientState, cachedTargetFiles));
    requestBuilder.post(requestBody);
    requestBuilder.addHeader(HEADER_DD_API_KEY, this.apiKey);
    return requestBuilder.build();
  }

  private String buildRemoteConfigRequestJson(Collection<String> productNames,
                                              ClientState clientState,
                                              Collection<CachedTargetFile> cachedTargetFiles) {
