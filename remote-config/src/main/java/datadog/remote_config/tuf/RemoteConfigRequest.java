...
public class RemoteConfigRequest {
  ...
  public static RemoteConfigRequest newRequest(
    ...
    ClientInfo clientInfo =
        new RemoteConfigRequest.ClientInfo(clientState, clientId, productNames, tracerVersion, tracerInfo);
  ...
  public static class ClientInfo {
    ...
    public static class ClientState {
      ...
      public void setState(long targetsVersion, List<ConfigState> configStates, String error, String backendClientState) {
  ...
  public static class CachedTargetFile {
    ...
    public CachedTargetFile(String path, long length, Map<String /*algo*/, String /*digest*/> hashes) {
      this.path = path;
      this.length = length;
